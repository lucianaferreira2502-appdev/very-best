...
#Can't tell if the hash is working or not. Is it storing any data right now?
     @hash = Gmaps4rails.build_markers(@venues.where.not(:address_latitude => nil)) do |venue, marker|
